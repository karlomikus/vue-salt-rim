...
export interface paths {
    ...
    "/generate/ingredient": {
        ...
        /**
         * Complete ingredient
         * @description Suggested ingredient information based on it's name, generated by an LLM.
         */
        post: operations["completeIngredient"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/generate/cocktail-tags": {
        ...
        /**
         * Cocktail tags
         * @description Suggested cocktail tags, based on existing cocktail information, generated by an LLM.
         */
        post: operations["completeCocktailTags"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/generate/cocktail-recipe-from-text": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Recipe from text
         * @description Generate a parseable json recipe structure from raw text.
         */
        post: operations["cocktailRecipeFromText"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        GeneratedCocktailFromTextResource: {
            /**
             * @description Generated name of the cocktail
             * @example Mojito
             */
            name: string;
            /**
             * @description Generated description of the cocktail
             * @example A refreshing Cuban cocktail made with white rum, lime juice, sugar, mint leaves, and soda water.
             */
            description?: string | null;
            /**
             * @description Generated garnish of the cocktail
             * @example Orange peel.
             */
            garnish?: string | null;
            /**
             * @description Generated preparation instructions for the cocktail
             * @example 1. Muddle mint leaves with sugar and lime juice in a glass.\n2. Add ice cubes and pour in the white rum.\n3. Top up with soda water and stir gently.\n4. Garnish with a sprig of mint and a lime wedge.
             */
            instructions: string;
            /**
             * @description Generated cocktail method
             * @example Shake
             */
            method?: string;
            ...
            ingredients: {
                ...
                name: string;
                /**
                 * @description Min amount of the ingredient
                 * @example 50
                 */
                amount: number;
                /**
                 * @description Max amount of the ingredient
                 * @example 50
                 */
                amount_max?: number | null;
                /**
                ...
                units: string;
                /**
                 * @description Additional note about the ingredient
                 * @example White Rum
                 */
                note?: string | null;
            }[];
        ...
        GeneratedCocktailTagsResource: {
            /**
             * @description Generated tags for the cocktail
             * @example [
             *       "classic",
             *       "fruity",
             *       "strong"
        ...
        GeneratedIngredientResource: {
            /**
             * @description Generated name of the ingredient
             * @example Vodka
             */
            name: string;
            /**
             * Format: float
             * @description Generated strength of the ingredient
             * @example 40
             */
            strength: number;
            /**
             * @description Generated description of the ingredient
             * @example Vodka is a clear distilled alcoholic beverage
             */
            description: string | null;
            /**
             * @description Generated origin of the ingredient
             * @example Russia
             */
            origin: string | null;
            /**
             * @description Generated color of the ingredient
             * @example #ffffff
             */
            color: string | null;
            /**
             * @description Generated distillery of the ingredient
             * @example Smirnoff
             */
    ...
    completeIngredient: {
        ...
        requestBody: {
            content: {
                "application/json": {
                    /**
                     * @description Name of the ingredient to complete information for
                     * @example Vodka
                     */
                    name: string;
                };
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        data: components["schemas"]["GeneratedIngredientResource"];
                    };
                };
            };
        };
    };
    completeCocktailTags: {
        parameters: {
            query?: never;
            header?: {
                /** @description Database id of a bar. */
        ...
        requestBody: {
            content: {
                "application/json": {
                    /**
                     * @description Id or slug of the ingredient
                     * @example Vodka
                     */
                    cocktail_id: string;
                };
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        data: components["schemas"]["GeneratedCocktailTagsResource"];
                    };
                };
            };
        };
    };
    cocktailRecipeFromText: {
        parameters: {
            query?: never;
            header?: {
                /** @description Database id of a bar. */
        ...
        requestBody: {
            content: {
                "application/json": {
                    /**
                     * @description The raw text of the cocktail recipe to parse
                     * @example My recipe details are here...
                     */
                    recipe: string;
                };
            };
