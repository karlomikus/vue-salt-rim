...
async function fetchCalculator(id: number): Promise<void> {
    ...
    try {
        ...
        evaluations.value = calculator.value?.blocks
            ?.filter((block) => block.type === "eval")
            .map((e) => {
                return {
                    block: e,
                    result: null,
...
async function save(): Promise<void> {
    ...
    if (calculator.value.id) {
        BarAssistantClient.updateCalculator(calculator.value.id, postData)
            .then(() => {
        ...
        BarAssistantClient.saveCalculator(postData)
            .then(() => {
                router.push({ name: "calculators.index" });
            })
            .catch((e) => {
                    ...
                    <div>
                        <div class="form-row-group">
                            <div class="form-group">
                                ...
                                <input
                                    :id="'calc-evaluation-label-' + evaluation.block.sort"
                                    class="form-input form-input--small"
                                    type="text"
                                    v-model="evaluation.block.label"
                                    required
                                />
                            </div>
                            <div class="form-group">
                                ...
                                <input
                                    :id="'calc-evaluation-description-' + evaluation.block.sort"
                                    class="form-input form-input--small"
                                    type="text"
                                    v-model="evaluation.block.description"
                                />
                            </div>
                            <div class="form-group">
                                <label class="form-label" :for="'calc-evaluation-prefix-' + evaluation.block.sort">{{ t("prefix") }}</label>
                                <input
                                    :id="'calc-evaluation-prefix-' + evaluation.block.sort"
                                    class="form-input form-input--small"
                                    type="text"
                                    v-model="evaluation.block.settings.prefix"
                                    style="width: 100px"
                                />
                            </div>
                            <div class="form-group">
                                ...
                                <input
                                    :id="'calc-evaluation-suffix-' + evaluation.block.sort"
                                    class="form-input form-input--small"
                                    type="text"
                                    v-model="evaluation.block.settings.suffix"
                                    style="width: 100px"
                                />
                            </div>
                            <div class="form-group">
                                ...
                                <input
                                    :id="'calc-evaluation-decimal-places-' + evaluation.block.sort"
                                    class="form-input form-input--small"
                                    type="text"
                                    v-model="evaluation.block.settings.decimal_places"
                                    style="width: 70px"
                                />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input
                                :id="'calc-evaluation-var-name-' + evaluation.block.sort"
                                class="form-input form-input--small"
                                type="text"
                                v-model="evaluation.block.variable_name"
                                required
                            />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <p>
                                {{ evaluation.block.settings?.prefix }} {{ evaluation.result ?? t("calculators.missing-result") }}
                                {{ evaluation.block.settings?.suffix }}
                            </p>
