        ...
        <form @submit.prevent="login" class="login-page__form">
            ...
            <template v-if="apiServerAvailable === true">
                ...
                <template v-if="server?.is_password_login_enabled ?? true">
                    ...
                    <div class="form-group">
                        <label class="form-label form-label--forgot-password" for="password"
                            >{{ t("password") }}: <RouterLink v-if="showForgotPassword" :to="{ name: 'forgot-password' }">Forgot password?</RouterLink></label
                        >
