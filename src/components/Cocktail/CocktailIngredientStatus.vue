<template>
    <div class="ingredient-shelf-status" :class="statusClass">
        <svg v-if="inShelf" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#000000" viewBox="0 0 256 256">
            <path
        ...
        <svg v-else-if="inShelfAsSubstitute" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#000000" viewBox="0 0 256 256">
            <path
        ...
        <svg v-else-if="inShelfAsComplex" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path
        ...
        <svg v-else xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256">
            ...
            <path d="M59.49,195.27a95.54,95.54,0,0,1-24-41.58" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="24" />
            ...
            <path d="M220.51,153.7a95.54,95.54,0,0,1-24,41.56" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="24" />
