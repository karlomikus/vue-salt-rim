            ...
            <div class="resource-search__content">
                <div class="resource-search__content__filter">
                    ...
                    <SaltRimDialog v-model="showCreateNewCollectionDialog">
                        <template #trigger>
                            <button type="button" class="button button--input" :title="$t('collections.add')" @click.prevent="showCreateNewCollectionDialog = !showCreateNewCollectionDialog">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                    <path fill="none" d="M0 0h24v24H0z" />
    ...
    data() {
        return {
            ...
            availableRefinements: {
                ...
                total_ingredients: [
                    { name: '>= ' + this.$t('n-ingredients', 3), active: false, id: '3' },
                    { name: '>= ' + this.$t('n-ingredients', 5), active: false, id: '5' },
                    { name: '>= ' + this.$t('n-ingredients', 7), active: false, id: '7' },
                ],
                missing_ingredients: [
                    { name: this.$t('n-ingredients', 1), active: false, id: '1' },
                    { name: this.$t('n-ingredients', 2), active: false, id: '2' },
                    { name: '>= ' + this.$t('n-ingredients', 3), active: false, id: '3' },
                ],
