        ...
        <div class="resource-search">
            ...
            <div class="resource-search__content">
                <div class="resource-search__content__filter">
                    ...
                    <button type="button" class="button button--icon" :title="$t('cocktail.randomize')" @click.prevent="goToRandomCocktail">
                    ...
                    <SaltRimDialog v-model="showCreateNewCollectionDialog">
                        <template #trigger>
                            <button type="button" class="button button--icon" :title="$t('collections.add')" @click.prevent="showCreateNewCollectionDialog = !showCreateNewCollectionDialog">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                    <path fill="none" d="M0 0h24v24H0z" />
