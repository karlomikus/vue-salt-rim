        ...
        <div class="block-container block-container--padded">
            <div class="form-group">
                ...
                <input
                    ...
                    type="text"
                    required
                    @input="skipSlugGenerationFromName == false ? updateSlug($event) : true"
                    @blur="skipSlugGenerationFromName = true"
                />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <SaltRimCheckbox
                    id="toggle-invite"
                    v-model="enableInvites"
                    :label="$t('bars.enable-invites')"
                    :description="$t('bars.enable-invites-description')"
                ></SaltRimCheckbox>
            </div>
            <div class="form-group">
