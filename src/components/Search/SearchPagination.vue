<template>
    <div class="resource-search__content__pagination">
        ...
        <div class="resource-search__content__pagination__links">
            <button type="button" class="button button--icon" :disabled="currentPage == 1" @click="changePage('prev')">
            ...
            <button type="button" class="button button--icon" :disabled="currentPage == meta.last_page" @click="changePage('next')">
