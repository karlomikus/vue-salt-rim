    ...
    <div>
        ...
        <div class="public-cocktail-grid-filters">
            <SaltRimDialog v-model="showFiltersDialog">
                <template #trigger>
                    <button class="button button--outline" @click="showFiltersDialog = !showFiltersDialog">
                ...
                <template #dialog>
                    ...
                    <div class="dialog-actions">
                        ...
                        <button type="submit" class="button button--dark" @click="showFiltersDialog = false">Filter</button>
                    </div>
                </template>
            </SaltRimDialog>
...
const queryToState = () => {
    ...
    activeFilters.value.filter.name = queryString.filter?.name || defaultRefinements.filter.name
    activeFilters.value.filter.bar_shelf = queryString.filter?.bar_shelf || defaultRefinements.filter.bar_shelf
}
