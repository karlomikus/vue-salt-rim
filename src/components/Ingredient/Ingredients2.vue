        ...
        <div class="resource-search">
            ...
            <div class="resource-search__content">
                ...
                <IngredientGridContainer v-if="ingredients.length > 0">
                    <IngredientGridItem v-for="ingredient in ingredients" :ingredient="ingredient" :userIngredients="[]" :shoppingList="[]" :key="ingredient.id" />
                ...
                <div class="resource-search__content__pagination">
                    ...
                    <div class="resource-search__content__pagination__links">
                        <button type="button" class="button button--outline button--icon" @click="changePage('prev')">
                        ...
                        <button type="button" class="button button--outline button--icon" @click="changePage('next')">
