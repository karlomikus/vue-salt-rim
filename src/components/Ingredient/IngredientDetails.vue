                        ...
                        <li>
                            <div class="shelf-actions">
                                <div class="block-container shelf-actions__action">
                                    ...
                                    <br>
                                    <small>Recipes matching ingredients in bar shelf will be shown to all bar members.</small>
                                </div>
                                <div class="block-container shelf-actions__action">
                                    ...
                                    <br>
                                    <small>Recipes matching ingredients in your shelf can only be managed by you.</small>
                                </div>
                                <div class="block-container shelf-actions__action">
